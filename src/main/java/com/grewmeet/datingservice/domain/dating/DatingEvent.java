...
//    }
//
//    public boolean maleIsAlreadyFull() {
//        return maleParticipantsCount() >= maxMaleParticipantsCount;
//    }
//
//    public Long maleParticipantsCount() {
//        return participants.stream()
//                .filter(DatingParticipant::isRequestedFromMale)
//                .count();
//    }
//
//    public boolean femaleIsAlreadyFull() {
//        return femaleParticipantsCount() >= maxFemaleParticipantsCount;
//    }
//
//    public Long femaleParticipantsCount() {
//        return participants.stream()
...
//
//        if(requestUser.getParticipants().stream().anyMatch(participation.getDatingEvent()::equals)) {
//            return true;
//        }
//
...
//        return Long.valueOf(participants.size());
//    }
